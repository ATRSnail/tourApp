...
//默认最多会缓存80张图片作为聚合显示元素图片,根据自己显示需求和app使用内存情况,可以修改数量
    ...
    private void addSingleClusterToMap(Cluster cluster) {
        ...
        marker.startAnimation();
        marker.setTitle(cluster.getmTitle());
        ...
        for (ClusterItem clusterItem : mClusterItems) {
            ...
            if (visibleBounds.contains(latlng)) {
                ...
                if (cluster != null) {
                    ...
                    cluster = new Cluster(latlng, clusterItem.getTitle());
    ...
    private BitmapDescriptor getBitmapDes(int num) {
        ...
        if (bitmapDescriptor == null) {
            ...
            if (mClusterRender != null && mClusterRender.getDrawAble(num) != null) {
                ...
                textView.setBackgroundResource(num > 1 ? R.drawable.defaultcluster : R.mipmap.gps_point);
            }
